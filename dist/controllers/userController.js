...
class MockUserStorage {
    constructor() {
        this.storageKey = 'mathquest_mock_users';
    }
    loadUsers() {
        try {
...
class UserController {
    static async getUser(req, res) {
        try {
            ...
            (0, logger_1.logUserAction)('user_data_retrieved', userId, { userId });
            res.json({
                success: true,
                data: {
                    id: user.id,
    ...
    static async updateUser(req, res) {
        try {
            ...
            (0, logger_1.logUserAction)('user_data_updated', userId, userData);
            res.json({
                success: true,
                data: updatedUser
            });
    ...
    static async getAllUsers(req, res) {
        try {
            const users = mockStorage.getAll().sort((a, b) => b.xp - a.xp);
